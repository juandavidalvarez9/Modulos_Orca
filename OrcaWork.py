...
dir_principal = '/home/dsalazar/Simulacion_ORCA/MnAl_NumFreq/'
...
def main():
    for base in range(1,len(Bases)):
        ...
        job_slurm.write('#SBATCH --mail-user=<"juan.alvarez.gamez@correounivalle.edu.co"> \n\n')
        ...
        orca_file.write('! KDIIS SOSCF Grid4 FinalGrid5 LargePrint xyzfile keepDens Opt NumFreq \n\n')
        orca_file.write('%maxcore 11000 \n\n')
        orca_file.write('%pal \n')
        orca_file.write('nprocs {} \n'.format(Numero_nucleos))
        orca_file.write('end \n\n')
        orca_file.write('%scf \n')
        orca_file.write('print[p_mos] 1		# Imprime orbitales moleculares. \n')        
        orca_file.write('FlipSpin 0			# FlipSpin es un vector y se puede dar una lista de atomos en la que se desea invertir el giro. \n')
        orca_file.write('FinalMs	 0.0			# El valor deseado de Ms del determinante de simetria rota. \n')
        orca_file.write('SOSCFStart 0.00000033		# Retraso en el inicio del gradiente orbital \n')
